...
const writableFields = {
  inventory: ['name','category','unit','current_stock','min_stock','max_stock','cost','supplier','supplier_id','forecast_per_event'],
  ...
  suppliers: ['name','category','vendor_type','phone','email','contact_name','website','address','delivery_days','default_order_day','lead_time_days','minimum_order','payment_terms','active','notes','membership_required','membership_number','membership_expiration'],
  ingredients: ['name','category','unit','quantity','cost','supplier','notes','servings_per_purchase','inventory_item_id'],
  vendors: ['name','category','vendor_type','phone','email','contact_name','website','address','delivery_days','default_order_day','lead_time_days','minimum_order','payment_terms','active','notes','membership_required','membership_number','membership_expiration'],
